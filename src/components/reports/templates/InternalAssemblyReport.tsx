...
export function InternalAssemblyReport({ inputs, outputs }: { inputs: TransformerInputs, outputs: TransformerOutputs }) {
  return (
    <div className="report-page">
      <ReportHeader title="Internal Assembly" inputs={inputs} />
      
      <div className="p-8 border-2 border-dashed border-slate-300 bg-slate-50 text-center rounded-lg mt-6">
        <h3 className="font-bold text-lg text-slate-700 mb-2">Detailed Internal Assembly View</h3>
