...
const SECTIONS: { id: string; title: string; keys: string[] }[] = [
  ...
  { id: 'core', title: 'Core', keys: ['coreGrade', 'coreType', 'coreConstruction', 'jointStacking', 'stackingOffset', 'centreJoint', 'overlapLength', 'laminationsPerStep', 'buildFactor', 'flux', 'steps', 'etK', 'aspect', 'autoWindow', 'autoFit', 'windowSpace'] },
