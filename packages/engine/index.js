...
function documentRegister(core, d, bom, project) {
  ...
  return [
    ...
    r(12, "Complete Bill of Materials", "part", "Costing tab, fully editable",
      "Item codes and supplier names now exist in the item master (orgs/{orgId}/items) -- the BOM UI does not yet pull them in per line, and per-line GST is not held"),
